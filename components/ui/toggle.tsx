...
const toggleVariants = cva(
  ...
  { variants: { variant: { default: "bg-transparent", outline: "border border-input bg-transparent hover:bg-muted" }, size: { default: "h-9 min-w-9 px-3", sm: "h-8 min-w-8 px-3", lg: "h-10 min-w-10 px-4" } }, defaultVariants: { variant: "default", size: "default" } }
)
